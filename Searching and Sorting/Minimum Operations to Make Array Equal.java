...
// where 0 <= x, y < n and subtract 1 from arr[x] and 
// add 1 to arr[y] (i.e. perform arr[x] -=1 and arr[y] += 1). 
// The goal is to make all the elements of the array equal. 
// It is guaranteed that all the elements of the array can be 
// made equal using some operations.
// Given an integer n, the length of the array. 
// Return the minimum number of operations needed to make all 
